...
public class UserPageTest extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_page_test);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.user_page_test, menu);
        return true;
    }
    ...
    private void clearContainer(){
        ...
        if(getSupportFragmentManager().findFragmentByTag("fragment_key")!=null){
            transaction.detach(getSupportFragmentManager().findFragmentByTag("fragment_key"));
            transaction.commit();
        }
    }
}
